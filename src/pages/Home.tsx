        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-3 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-300">
                <li><Link href="/conciergerie" className="hover:text-white transition">Conciergerie</Link></li>
                <li><Link href="/strategie" className="hover:text-white transition">Stratégie d'Affaires</Link></li>
                <li><Link href="/intelligence-artificielle" className="hover:text-white transition">Intelligence Artificielle</Link></li>
                <li><a href="#contact" className="hover:text-white transition">Contact</a></li>
                <li><Link href="/qui-sommes-nous" className="hover:text-white transition">Qui sommes-nous</Link></li>
                <li><Link href="/carrieres" className="hover:text-white transition">Carrières</Link></li>
              </ul>
            </div>
            <div>
          ...
          <div className="border-t border-gray-700 pt-8 text-center text-gray-300">
            ...
            <p className="mt-2 text-sm">
              <Link href="/politique-de-confidentialite" className="hover:text-white underline transition">Politique de confidentialité</Link>
              {" · "}
              <Link href="/qui-sommes-nous" className="hover:text-white underline transition">Qui sommes-nous</Link>
              {" · "}
              <Link href="/carrieres" className="hover:text-white underline transition">Carrières</Link>
            </p>
          </div>
        </div>
      </footer>
